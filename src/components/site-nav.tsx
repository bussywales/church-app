...
function NavLink({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "inline-flex min-h-11 shrink-0 items-center rounded-full px-3 text-sm font-bold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-4 focus-visible:ring-offset-ivory",
        subtle
    ...
    <header className="sticky top-0 z-40 border-b border-white/70 bg-ivory/86 shadow-[0_12px_35px_rgba(14,36,71,0.08)] backdrop-blur-xl">
      ...
      >
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          <span className="mx-1 hidden h-11 w-px shrink-0 bg-border sm:block" />
